...
<body>
    <div style="text-align:center;"><b>Cell House CSM1</b><br>Real Time Data Logging with Graphs on ESP32 of Cell 1 </div>
    <div class="chart-container" position: relative; height:350px; width:100%">
        <canvas id="Chart" width="400" height="400"></canvas>
    </div>
<div>
	<table id="dataTable">
	  <tr><th>No.</th><th>Time</th><th>Temprature Value</th></tr>
	</table>
</div>
<br>
<br>	
...
function getData() {
  ...
  xhttp.onreadystatechange = function() {
    ...
    cell10 = cell10 + 1
    cell0.innerHTML = cell10;
	  cell1.innerHTML = time;
	  cell2.innerHTML = ADCValue;
    var temp =Number(ADCValue);
    if (temp < 15 || temp > 45)
    beep();
    }
  };
